...
- (void)setupFinanceProductFrame
{
    ...
    CGFloat titleLabelMaxW = _scrollViewF.size.width - margin;
    ...
    /** dateLabel */
    CGFloat dateLabelX = margin;
    CGFloat dateLabelY = CGRectGetMaxY(_titleLabelF);
    CGFloat dateLabelW = _scrollViewF.size.width * 0.5 - margin;
    ...
    CGFloat leftTimeLabelW = _scrollViewF.size.width * 0.5 - margin;
    ...
    /** 图表区域整体的view */
    CGFloat chartViewX = margin;
    CGFloat chartViewY = CGRectGetMaxY(_dateLabelF) + margin;
    CGFloat chartViewW = _scrollViewF.size.width;
    
    /** currentInterestView 银行活期利息 */
    CGFloat currentInterestViewX = 0;
    CGFloat currentInterestViewY = margin;
    ...
    CGFloat expEarningViewX = _scrollViewF.size.width * 0.3 + margin;
    ...
    CGFloat multipleLabelX = _scrollViewF.size.width * 0.3 * 2 + margin;
    CGFloat multipleLabelY = margin * 0.5;
    ...
    CGFloat basicInfoButtonY = CGRectGetMaxY(_comparisonViewF) + margin;
    ...
    CGFloat basicInfoViewY = CGRectGetMaxY(_basicInfoButtonF) + margin;
    ...
    CGFloat arriveTimeLabelY = margin * 0.5;
    ...
    CGFloat arriveTimeInfoLabelW = chartViewW - margin - arriveTimeInfoLabelX;
    ...
    CGFloat assetManagerLabelY = CGRectGetMaxY(_arriveTimeLabelF) + margin;
    ...
    CGFloat assetManagerInfoLabelW = chartViewW - margin - assetManagerInfoLabelX;
...
//    _assetManagerInfoLabelF = (CGRect){{assetManagerInfoLabelX, assetManagerInfoLabelY}, assetManagerInfoLabelS};
    ...
    CGFloat subscriptionTimeLabelY = CGRectGetMaxY(_assetManagerLabelF) + margin;
    ...
    CGFloat subscriptionTimeInfoLabelW = chartViewW - margin - subscriptionTimeInfoLabelX;
...
//    _subscriptionTimeInfoLabelF = (CGRect){{subscriptionTimeInfoLabelX, subscriptionTimeInfoLabelY}, subscriptionTimeInfoLabelS};
    ...
    CGFloat earningTimeLabelY = CGRectGetMaxY(_subscriptionTimeLabelF) + margin;
    ...
    CGFloat earningTimeInfoLabelW = chartViewW - margin - earningTimeInfoLabelX;
...
//    _earningTimeInfoLabelF = (CGRect){{earningTimeInfoLabelX, earningTimeInfoLabelY}, earningTimeInfoLabelS};
    ...
    CGFloat expEarningCulViewY = CGRectGetMaxY(_basicInfoButtonF) + margin;
    ...
    /** moneyYuanLabelF */
    CGFloat moneyYuanLabelX = CGRectGetMaxX(_moneyAmountTextFieldF) + margin * 0.5;
    ...
    /** middleLabelF */
    CGFloat middleLabelX = CGRectGetMaxX(_moneyYuanLabelF) + margin * 2;
    ...
    /** equalLabelF */
    CGFloat equalLabelX = CGRectGetMaxX(_middleLabelF) + margin * 2;
    ...
    CGFloat calculateButtonX = (_scrollViewF.size.width - margin * 2) * 0.5 - calculateButtonW * 0.5;
    CGFloat calculateButtonY = CGRectGetMaxY(_moneyAmountTextFieldF) + margin;
    ...
    CGFloat attentionLabelY = CGRectGetMaxY(_calculateButtonF) + margin;
    CGFloat attentionLabelW = _scrollViewF.size.width - margin * 2;
    ...
    CGFloat detailInfoLabelY = CGRectGetMaxY(_basicInfoButtonF) + margin * 2 + 100;
    ...
    CGFloat detailInfoContentLabelY = CGRectGetMaxY(_detailInfoLabelF) + margin;
