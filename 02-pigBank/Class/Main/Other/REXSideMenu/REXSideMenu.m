...
@property (nonatomic, strong) NSString *ConsultantUid;
@property (nonatomic, strong) NSString *ConsultantName;
@property (nonatomic, strong) NSString *Consultanturl;
...
//        NSUserDefaults *mySettingData = [NSUserDefaults standardUserDefaults];
//        NSString *theuid = [mySettingData objectForKey:@"uid"];
//        NSString *thetoken = [mySettingData objectForKey:@"token"];
//        NSMutableDictionary *dic = [NSMutableDictionary dictionary];
//        [dic setObject:theuid forKey:@"uid"];
//        [dic setObject:thetoken forKey:@"token"];
//        [User userCatchConsultant:dic WithBlock:^(User *user, NSError *error) {
//            _ConsultantUid = user.userId;
//            _Consultanturl = user.pictureUrl;
//            _ConsultantName =user.dispName;
//        }];}
}
#pragma mark -
...
- (void)__presentMenuViewContainerWithMenuViewController:(UIViewController *)menuViewController
{
    ...
    if ([self.delegate conformsToProtocol:@protocol(REXSideMenuDelegate)] && [self.delegate respondsToSelector:@selector(sideMenu:willShowMenuViewController:)]) {
...
- (void)__showLeftMenuViewController
{
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        if (!self.visible && [self.delegate conformsToProtocol:@protocol(REXSideMenuDelegate)] && [self.delegate respondsToSelector:@selector(sideMenu:didShowMenuViewController:)]) {
...
- (void)__showRightMenuViewController
{
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        if (!self.rightMenuVisible && [self.delegate conformsToProtocol:@protocol(REXSideMenuDelegate)] && [self.delegate respondsToSelector:@selector(sideMenu:didShowMenuViewController:)]) {
...
- (void)__hideMenuViewControllerAnimated:(BOOL)animated
{
    ...
    if ([self.delegate conformsToProtocol:@protocol(REXSideMenuDelegate)] && [self.delegate respondsToSelector:@selector(sideMenu:willHideMenuViewController:)]) {
    ...
    void (^completionBlock)(void) = ^{
        ...
        if (!strongSelf.visible && [strongSelf.delegate conformsToProtocol:@protocol(REXSideMenuDelegate)] && [strongSelf.delegate respondsToSelector:@selector(sideMenu:didHideMenuViewController:)]) {
...
{
    if ([self.delegate conformsToProtocol:@protocol(REXSideMenuDelegate)] && [self.delegate respondsToSelector:@selector(sideMenu:didRecognizePanGesture:)])
    ...
    if (recognizer.state == UIGestureRecognizerStateChanged) {
        ...
        if (!self.didNotifyDelegate) {
            if (point.x > 0) {
                if (!self.visible && [self.delegate conformsToProtocol:@protocol(REXSideMenuDelegate)] && [self.delegate respondsToSelector:@selector(sideMenu:willShowMenuViewController:)]) {
...
//        
//        if (index == 0) {
//            [self setContentViewController:[[BaseNavigationController alloc] initWithRootViewController:[[HomePageViewController alloc]init]]animated:NO];
//        }
//        else if (index == 1){
//            [self setContentViewController:[[BaseNavigationController alloc] initWithRootViewController:[[PrivilegeViewController alloc]init]]animated:NO];
//        }
//        else if (index == 2){
//            
//            EMELPDialogVC *lpDialogVC = [[EMELPDialogVC alloc] init];
//            EMELPFamily *lpFamliy = [[EMELPFamily alloc] init];
//            [lpFamliy setAttributeWithUserId:[NSString stringWithFormat:@"%@",_ConsultantUid]
//                                    UserName:_ConsultantName
//                                UserNickName:_ConsultantName
//                                 UserHeadURL:_Consultanturl
...
//            BaseNavigationController * navigationgVC = (BaseNavigationController *)self.contentViewController;
//            [navigationgVC pushViewController:lpDialogVC animated:YES];
//            });
//        }
//        else if (index == 3){
//            NSUserDefaults *mySettingData = [NSUserDefaults standardUserDefaults];
...
//            [dic setObject:thetoken forKey:@"token"];
//            [User userCatchConsultant:dic WithBlock:^(User *user, NSError *error) {
//                Consultantmobile = user.mobile;
//                if ([Consultantmobile isEqual:nil]) {
//                    NIF_INFO(@"无电话");
//                }else{
//                    [[UIApplication sharedApplication]openURL:[NSURL URLWithString:[NSString stringWithFormat:@"telprompt:%@",Consultantmobile]]];
//                }
//            }];
//        }
//    }
//    
//    else if ([strid intValue]==ConsultantType){//理财顾问
//        if (index == 0) {
//            [self setContentViewController:[[BaseNavigationController alloc] initWithRootViewController:[[HomePageViewController alloc]init]]animated:NO];
//        }
//        else if (index == 1){
...
//            BaseNavigationController * navigationgVC = (BaseNavigationController *)self.contentViewController;
//            [navigationgVC pushViewController:chatVC animated:YES];
//        }
//        else if (index == 2){
//            MyClientsViewController * myVC = [[ MyClientsViewController alloc ]init];
//            BaseNavigationController * navigationgVC = (BaseNavigationController *)self.contentViewController;
//            [navigationgVC pushViewController:myVC animated:YES];
//        }
//    }
//}
...
//- (void)bringDockView
//{
//    [dockV removeFromSuperview];
//    [self.contentViewContainer addSubview:dockV];
//}
